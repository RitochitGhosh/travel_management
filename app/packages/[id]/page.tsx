...
export default function PackageDetails() {
  const { id } = useParams();
  const package = packages.find((p) => p.id === parseInt(id as string));
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <Tabs defaultValue="overview">
            ...
            <TabsContent value="overview" className="space-y-4">
              <h2 className="text-2xl font-bold">{package.name}</h2>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <Card className="p-4">
                  ...
                  <p className="text-lg">{package.type}</p>
                </Card>
                <Card className="p-4">
                  <Star className="h-5 w-5 mb-2" />
                  <p className="text-sm font-medium">Rating</p>
                  <p className="text-lg">{package.rating}/5</p>
                </Card>
                <Card className="p-4">
        ...
        <div className="lg:col-span-1">
          <Card className="p-6">
            <h3 className="text-2xl font-bold mb-4">${package.price}</h3>
            <div className="space-y-4">
              <div>
